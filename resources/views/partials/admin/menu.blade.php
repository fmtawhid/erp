...
<!-- <nav style="background-color: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'aliceblue' }};" class="dash-sidebar light-sidebar transprent-bg"> -->
<!-- <nav class="dash-sidebar light-sidebar transprent-bg"> -->
<nav class="dash-sidebar light-sidebar transprent-bg" style="background: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'aliceblue' }};">
    @else
    <!-- <nav class="dash-sidebar light-sidebar" style="background-color: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'aliceblue' }};"> -->
    <nav class="dash-sidebar light-sidebar" style="background: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'aliceblue' }};">
        @endif
        <div class="navbar-wrapper">
            <div class="m-header main-logo">
                <!-- <a href="#" class="b-brand"> 
                    @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on') 
                    <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') . '?' . time() }}" alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg"> 
                    @else
                    <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png') . '?' . time() }}" alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg">
                    @endif
                </a> -->
                <!-- <a href="#" class="b-brand">
                    @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
                ...
                <a href="#" class="b-brand">
                    <img id="main-logo" src="{{ $logo . '/' . ($setting['cust_darklayout'] == 'on' ? (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') : (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png')) . '?' . time() }}" alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg">
                </a>
            </div>
            <div class="navbar-content">
                ...
                <ul class="dash-navbar">
                    ...
                    <li class="dash-item dash-hasmenu
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('Accounting ') }}<span class="dash-arrow"><i
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item dash-hasmenu
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <li class="dash-item {{ request()->is('report-leave') ? 'active' : '' }}">
                                                <a class="dash-link"
                            ...
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('CRM') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    <li
                            ...
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('POS') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    <li
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'holiday-calender' ||
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('Payroll Setup') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                            ...
                            @if (Gate::check('manage indicator') || Gate::check('manage appraisal') ||
                            ...
                            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking' ? 'active dash-trigger' : '' }}"
                                ...
                                <a class="dash-link" href="#">{{ __('Performance Setup') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul
                            ...
                            @if (Gate::check('manage training') || Gate::check('manage trainer') || Gate::check('show
                            training'))
                            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'trainer' || Request::segment(1) == 'training' ? 'active dash-trigger' : '' }}"
                                ...
                                <a class="dash-link" href="#">{{ __('Training Setup') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    @can('manage training')
                            ...
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('Recruitment Setup') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    @can('manage job')
                                    <li
                            ...
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('HR Admin Setup') }}<span class="dash-arrow"><i
                                            data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    @can('manage award')
                    ...
                    @if (\Auth::user()->type != 'super admin' && (Gate::check('manage user') || Gate::check('manage
                    role') || Gate::check('manage client')))
                    ...
                    @if (\Auth::user()->type != 'super admin')
                    @if (Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage
                    company settings'))
