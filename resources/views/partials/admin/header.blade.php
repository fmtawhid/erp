...
@if (isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on')
    <!-- <header class="dash-header transprent-bg" style="background: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'azure' }};"> -->
    <!-- <header class="dash-header transprent-bg" style="background: azure;"> -->
    <header class="dash-header transprent-bg" style="background: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'azure' }};">
@else
    <!-- <header class="dash-header" style="background: azure;"> -->
    <!-- <header class="dash-header" style="background: {{ (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '#111' : 'azure' }};"> -->
