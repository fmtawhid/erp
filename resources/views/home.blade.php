...
<head>
    ...
    <title>COPA ERP</title>
    <!-- favicon -->
    <link rel="icon" href="https://demo.workdo.io/erpgo-saas/storage/uploads/logo/favicon.png?1748175577"
        type="image/x-icon">
...
<body>
    ...
    <a href="{{ url('/pages/about_us') }}" target="_blank" class="button first"><button>About</button><span></span></a>

    <a href="{{ url('/login') }}" target="_blank" class="button sec"><button>Login</button><span></span></a>

    <a href="https://rafusoft.com/contact" target="_blank" class="button third"><button>Contact</button><span></span></a>
    ...
    <svg class="bottom-left" width="232" height="191" viewBox="0 0 232 191" fill="none"
        xmlns="http://www.w3.org/2000/svg">
