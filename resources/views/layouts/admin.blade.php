...
<body class="{{ $themeColor }}">
    ...
    <!-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            const darkLayoutCheckbox = document.getElementById('cust-darklayout');
            const sidebar = document.querySelector('.dash-sidebar');

            if (darkLayoutCheckbox && sidebar) {
                darkLayoutCheckbox.addEventListener('change', function() {
                    if (this.checked) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const darkLayoutCheckbox = document.getElementById('cust-darklayout');
            const sidebar = document.querySelector('.dash-header');
            ...
            if (darkLayoutCheckbox && sidebar) {
                darkLayoutCheckbox.addEventListener('change', function() {
                    if (this.checked) {
                        ...
                        sidebar.style.backgroundColor = 'azure';
                    }
                });
    ...
    <!-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTheme() {
                if (darkLayoutCheckbox && sidebar) {
                    sidebar.style.backgroundColor = darkLayoutCheckbox.checked ? '#111' : 'aliceblue';
                }
                if (darkLayoutCheckbox && header) {
                    header.style.backgroundColor = darkLayoutCheckbox.checked ? '#111' : 'azure';
                }
            }

            if (darkLayoutCheckbox) {
                darkLayoutCheckbox.addEventListener('change', updateTheme);
                updateTheme();
            }
        });
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const logoDark = @json($logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') . '?' . time());
            const logoLight = @json($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png') . '?' . time());

            if (darkLayoutCheckbox && logoImg) {
                darkLayoutCheckbox.addEventListener('change', function () {
                    logoImg.src = this.checked ? logoLight : logoDark;
                });
                
                logoImg.src = darkLayoutCheckbox.checked ? logoLight : logoDark;
            }
        });
    </script> -->
